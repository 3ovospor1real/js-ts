...
var caracterQtd = document.querySelector('#caracteres');
var chkUpper = document.querySelector('.chk-upper');
...
var Generator = /*#__PURE__*/function () {
  ...
  _createClass(Generator, null, [{
    ...
    key: "generateUpper",
    value: function generateUpper() {
      return String.fromCharCode(Generator.random(65, 91));
    }
  }, {
    key: "generateLower",
    value: function generateLower() {
...
function generatePassword(qtd, lower, upper, number, symbol) {
...
`, "",{"version":3,"sources":["webpack://./src/assets/css/style.css"],"names":[],"mappings":"AACA;EACE,wBAAwB;EACxB,+BAA+B;AACjC;;AAEA;EACE,sBAAsB;EACtB,UAAU;AACZ;;AAEA;EACE,SAAS;EACT,UAAU;EACV,gCAAgC;EAChC,oCAAoC;EACpC,gBAAgB;EAChB,kBAAkB;AACpB;;AAEA;EACE,gBAAgB;EAChB,iBAAiB;EACjB,gBAAgB;EAChB,aAAa;EACb,mBAAmB;AACrB;;AAEA;EACE,cAAc;EACd,WAAW;EACX,mBAAmB;AACrB;;AAEA;EACE,eAAe;EACf,YAAY;EACZ,eAAe;AACjB;;AAEA;EACE,uCAAuC;AACzC;;AAEA;EACE,YAAY;EACZ,kBAAkB;EAClB,gCAAgC;EAChC,WAAW;EACX,eAAe;EACf,gBAAgB;EAChB,YAAY;EACZ,eAAe;EACf,gBAAgB;AAClB;;AAEA;EACE,mBAAmB;AACrB;;AAEA;EACE,gBAAgB;EAChB,2BAA2B;EAC3B,mBAAmB;EACnB,qBAAqB;EACrB,kBAAkB;EAClB,YAAY;EACZ,kBAAkB;EAClB,uBAAuB;AACzB;;AAEA;EACE,uCAAuC;AACzC;;AAEA;EACE,YAAY;AACd;;AAEA;EACE,WAAW;EACX,YAAY;AACd","sourcesContent":["@import url('https://fonts.googleapis.com/css?family=Open+Sans:400,700&display=swap');\n:root {\n  --primary-color: #001b50;\n  --primary-color-darker: #000f2e;\n}\n\n* {\n  box-sizing: border-box;\n  outline: 0;\n}\n\nbody {\n  margin: 0;\n  padding: 0;\n  background: var(--primary-color);\n  font-family: 'Open sans', sans-serif;\n  font-size: 1.3em;\n  line-height: 1.5em;\n}\n\n.container {\n  max-width: 640px;\n  margin: 50px auto;\n  background: #fff;\n  padding: 20px;\n  border-radius: 10px;\n}\n\nform input, form label, form button {\n  display: block;\n  width: 100%;\n  margin-bottom: 10px;\n}\n\nform input {\n  font-size: 24px;\n  height: 50px;\n  padding: 0 20px;\n}\n\nform input:focus {\n  outline: 1px solid var(--primary-color);\n}\n\nbutton {\n  border: none;\n  border-radius: 8px;\n  background: var(--primary-color);\n  color: #fff;\n  font-size: 16px;\n  font-weight: 600;\n  height: 40px;\n  cursor: pointer;\n  margin-top: 10px;\n}\n\nh1{\n  margin-bottom: 10px;\n}\n\n.result {\n  font-size: 1.4em;\n  color: var(--primary-color);\n  margin-bottom: 10px;\n  background: #0000000d;\n  width: fit-content;\n  padding: 7px;\n  border-radius: 8px;\n  border: 1px solid black;\n}\n\nbutton:hover {\n  background: var(--primary-color-darker);\n}\n\ninput[type=\"number\"] {\n  height: 20px;\n}\n\ninput[type=\"checkbox\"] {\n  width: 18px;\n  height: 18px;\n}\n\n"],"sourceRoot":""}]);
// Exports
...
/* harmony import */ var _modules_createPassword__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/createPassword */ "./src/modules/createPassword.js");


(0,_modules_createPassword__WEBPACK_IMPORTED_MODULE_1__["default"])();
})();
